...
<div class="@twMerge('mb-4 border-b border-gray-200 dark:border-gray-700', $parentClass)">
            ...
            <li class="me-2" role="presentation">
                <button
                    class="{{ $index === 0 
                        ...
                        : 'inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 font-bold' }}"
                    id="{{ $tab['id'] }}-tab"
