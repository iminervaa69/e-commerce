...
@if ($toggle == 'open')
    <div value = "{{ $toggle }}" id="{{ $id }}" class="inline-flex rounded-md shadow-xs w-full" role="group" toggle = {{ $toggle }} >
        ...
        <button id="{{ $id_toggleoff }}"  type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-e-lg  text-white border-gray-800 bg-gray-700 hover:bg-gray-800 focus:ring-2 focus:ring-gray-300  dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900">
        <svg class="w-3 h-6 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
@elseif ($toggle == 'close')
    <div value="{{ $toggle }}" id="{{ $id }}" class="inline-flex rounded-md shadow-xs w-full" role="group"  >
        ...
        <button id="{{ $id_toggleoff }}"  type="button" class="w-6/7 inline-flex items-center px-4 py-2 text-sm font-medium rounded-e-lg  text-white border-red-800 bg-red-700 hover:bg-red-800 focus:ring-2 focus:ring-red-300  dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
        <svg class="w-3 h-6 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            <path d="M14.707 7.793a1 1 0 0 0-1.414 0L11 10.086V1.5a1 1 0 0 0-2 0v8.586L6.707 7.793a1 1 0 1 0-1.414 1.414l4 4a1 1 0 0 0 1.416 0l4-4a1 1 0 0 0-.002-1.414Z"/>
            <path d="M18 12h-2.55l-2.975 2.975a3.5 3.5 0 0 1-4.95 0L4.55 12H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2Zm-3 5a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"/>
        </svg>
