...
<div class="@twMerge('flex', $parentClass)">
    ...
    <input 
        ...
        class="@twMerge('rounded-none ' . ($right_svg ? '' : 'rounded-e-lg') . ' bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block w-full text-sm p-2.5', $inputClass)"
    >
