...
<div class="p-4 border-2 border-gray-200 border-dashed rounded-lg mt-14">
    <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
        <p class="block mb-2 text-m ms-2 font-medium text-gray-900">Store Details</p>
        ...
        <form class="mx-auto h-full" action="{{ route('stores.update', $store->id) }}" method="POST">
            ...
            <div class="flex gap-10 w-full p-4">
                ...
                <div class="w-1/2">
                    ...
                    <div class="flex gap-4 w-full ">
                        ...
                        <p class="text-gray-500 text-sm self-center">-</p>
                        <div class="flex w-2/5">
            ...
            <div id="save-group" class="flex flex-column mt-4 sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-end pr-2 pb-2">
                <x-button.button1 label="Cancel" id="btn-cancel" color="red"
                    svg='<svg class="w-4 h-5 mr-1.5 text-red-500 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" /></svg>'/>
...
const updateToggleStyle = (state) => {
    ...
    if (state === 'open') {
        ...
        btnOpen.className = 'w-6/7 inline-flex items-center px-4 py-2 text-sm font-medium rounded-s-lg focus:ring-2 border-green-800 text-white bg-green-700 hover:bg-green-800 focus:ring-green-300';

        btnClose.className = 'inline-flex items-center px-4 py-2 text-sm font-medium rounded-e-lg text-white border-gray-800 bg-gray-700 hover:bg-gray-800 focus:ring-2 focus:ring-gray-300';
    } else {
        console.log('style to close');

        btnOpen.className = 'inline-flex items-center px-4 py-2 text-sm font-medium rounded-s-lg focus:ring-2 border-gray-800 text-white bg-gray-700 hover:bg-gray-800 focus:ring-gray-300';

        btnClose.className = 'w-6/7 inline-flex items-center px-4 py-2 text-sm font-medium rounded-e-lg text-white border-red-800 bg-red-700 hover:bg-red-800 focus:ring-2 focus:ring-red-300';
    }
};
