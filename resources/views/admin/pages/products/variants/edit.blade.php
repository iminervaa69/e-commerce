...
<div class="p-4 border-2 border-gray-200 border-dashed rounded-lg mt-14">
    <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between">
        <p class="block mb-2 text-m ms-2 font-medium text-gray-900">Product Variant Details</p>
...
const updateToggleStyle = (state) => {
    ...
    if (state === 'available') {
        ...
        btnAvailable.className = 'w-6/7 inline-flex items-center px-4 py-2 text-sm font-medium rounded-s-lg focus:ring-2 border-green-800 text-white bg-green-700 hover:bg-green-800 focus:ring-green-300';

        btnUnavailable.className = 'inline-flex items-center px-4 py-2 text-sm font-medium rounded-e-lg text-white border-gray-800 bg-gray-700 hover:bg-gray-800 focus:ring-2 focus:ring-gray-300';
    } else {
        console.log('style to unavailable');

        btnAvailable.className = 'inline-flex items-center px-4 py-2 text-sm font-medium rounded-s-lg focus:ring-2 border-gray-800 text-white bg-gray-700 hover:bg-gray-800 focus:ring-gray-300';

        btnUnavailable.className = 'w-6/7 inline-flex items-center px-4 py-2 text-sm font-medium rounded-e-lg text-white border-red-800 bg-red-700 hover:bg-red-800 focus:ring-2 focus:ring-red-300';
    }
};
