        ...
        <div class="flex justify-between items-center max-w-screen-2xl mx-auto">
            ...
            <div class="flex items-center space-x-1 sm:space-x-2">
                ...
                <div id="main-notifications" class="relative hide-md">
                    ...
                    {{-- <span class="hidden lg:block ml-1 text-sm text-gray-700 dark:text-gray-300 self-center">Notifications</span> --}}
                ...
                <div  class="relative flex items-center">
                    ...
                    <div id="main-user" class="relative ">
                        ...
                        />
                        <!-- User Dropdown Menu -->
                        {{-- <div id="userDropdownMenu" class="hidden absolute right-0 mt-2 w-56 bg-white dark:bg-gray-700 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 z-50">
                            <!-- User Info Header -->
                            ...
                            <!-- Menu Items -->
                            <div class="py-2">
                                <a  class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600">
